...
fn test_decrypt_typescript_messages() -> Result<()> {
    ...
    if !vectors_path.exists() {
        println!("TypeScript vectors not found at {:?}, skipping...", vectors_path);
...
fn test_generate_rust_vectors() -> Result<()> {
    let alice_sk = hex_to_bytes32("1111111111111111111111111111111111111111111111111111111111111111");
    let bob_sk = hex_to_bytes32("2222222222222222222222222222222222222222222222222222222222222222");
    let shared_secret = hex_to_bytes32("3333333333333333333333333333333333333333333333333333333333333333");
    ...
    let vectors = TestVector {
        ...
        alice_ephemeral_sk: "1111111111111111111111111111111111111111111111111111111111111111".to_string(),
        alice_ephemeral_pk: hex::encode(alice_pk.to_bytes()),
        bob_ephemeral_sk: "2222222222222222222222222222222222222222222222222222222222222222".to_string(),
        bob_ephemeral_pk: hex::encode(bob_pk.to_bytes()),
        shared_secret: "3333333333333333333333333333333333333333333333333333333333333333".to_string(),
        messages,
    };
