---- MODULE ReplicatedControlState_TTrace_1772973874 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ReplicatedControlState_TTrace_1772973874.json", _TETrace)
...
\*
\*trace == IODeserialize("ReplicatedControlState_TTrace_1772973874.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ReplicatedControlState_TTrace_1772973874 ----
CONSTANTS
    Devices = { d1 , d2 }
    Stamps = { 1 , 2 , 3 }
    DeletedStamps = { 3 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Mar 08 14:44:34 EET 2026